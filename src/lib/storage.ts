...
const defaultProducts: Product[] = [
  ...
  },
  {
    id: '2',
    name: 'Bacon Supreme',
    description: 'Duplo hambúrguer, bacon crocante, queijo, cebola caramelizada',
    price: 36.90,
  ...
  },
  {
    id: '3',
    name: 'Cheese Lovers',
    description: 'Hambúrguer 150g com triplo queijo: cheddar, prato e gorgonzola',
    price: 32.90,
  ...
  },
  {
    id: '4',
    name: 'Veggie Burger',
    description: 'Hambúrguer de grão de bico, rúcula, tomate seco e maionese de ervas',
    price: 26.90,
  ...
  },
  {
    ...
    description: 'Porção de batatas fritas com cheddar e bacon',
    price: 18.90,
